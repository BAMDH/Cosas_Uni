# -*- coding: utf-8 -*-
"""
Created on Sun May 15 15:25:34 2022
...
def conseguir_posicion(matriz, posicion, ventana, fila, lista1):
    """
    ...
    if(posicion == len(matriz[fila])):
        ...
        media = calculo_media(ventana_elemento)
        return conseguir_posicion(matriz, posicion + 1, ventana, fila, lista1 + [media])

def recorrer_matriz(lista, elemento, ventana, lista1):
    """
    recorre la matriz
    ...
    if(elemento == len(lista)):
        ...
        return recorrer_matriz(lista, elemento + 1, ventana, lista1 + [conseguir_posicion(lista, 0, ventana, elemento, [])])
...
def guardar_imagen():
    ...
    resultado = recorrer_matriz(lista, 0, ventana, [])
