 ...
 * @author Usuario
 */
public class MarcaAll extends javax.swing.JFrame {
...
/**
    ...
    */
    private void cargarTexto(){
        ...
        int total= config.getNumAtletas();
        if (total ==0){
            total=prueba.getMarcas().size();
        }
        for(int i= 0;i< total;i++){
           
            mensaje+=prueba.getMarcas().get(i).porCompetencia();
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MarcaAll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
